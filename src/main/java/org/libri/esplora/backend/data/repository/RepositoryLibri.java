...
public interface RepositoryLibri extends RepositoryAstratta<Libri> {
    ...
    ORDER BY VotoMedio;
    """, nativeQuery = true)
    List<RisultatoRicerca> ricerca(String parametroRicerca, String valoreRicerca, Year annoMin, Year annoMax, Float prezzoMin, Float prezzoMax, Short pagineMin, Short pagineMax, Byte valutazioneMin, String genere, String lingua);
}
